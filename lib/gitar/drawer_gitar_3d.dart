...
class _Drawer3DState extends State<Drawer3D>
 ...
 late AnimationController _animationController;
  ...
  void onOfflineStartPlaying(ImageSequenceAnimatorState _imageSequenceAnimator) {
    setState(() {});
  }
  void onOfflineFinishPlaying(ImageSequenceAnimatorState _imageSequenceAnimator) {
    setState(() {});
  }
  ...
  _build3dObject() => Positioned(
    ...
    left: (_maxSlide - _screen.width * 0.5)+20,
    ...
    child: AnimatedBuilder(
      ...
      builder: (_, __) => ImageSequenceAnimator(
        ...
        onStartPlaying: onOfflineStartPlaying,
        onFinishPlaying: onOfflineFinishPlaying,
